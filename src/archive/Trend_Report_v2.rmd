...
cat(
paste0("Highlights:
Over the past week, a daily moving average of ",key_Can_avg_tests_per_day," tests have been performed for COVID-19 across Canada, for a total of ",key_Can_weekly_tests," tests. The weekly percent positivity (7MA) is ",key_Can_weekly_perc_positive))
```
