...
ax2.plot(National_Daily.Date, National_Daily["percent_positive_7MA"],color="red",marker="",markersize=12,label="Percent Positive (7MA)")
...
#set y axis limits
max_y2=National_Daily["percent_positive_7MA"].max(skipna=True)*1.2
...
# fig.savefig(main_folder_string+'./output/Testing_National.png',
#     format='png',
# dpi=300,
# bbox_inches='tight')
